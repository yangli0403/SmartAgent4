...
**智能对话交互系统** — 整合个性引擎、记忆系统、情感表达与**多智能体协同架构**的多模态 AI 助手平台。
...
- **三层记忆系统**：情景记忆、语义记忆、人格记忆，含四层过滤管道和记忆巩固/遗忘机制
...
用户消息
    ↓
[contextEnrichNode] — 上下文增强（记忆检索 + 画像构建 + 动态 Prompt）
    ↓
...
|------|-----------|-----------|-----------|
| agentCardRegistry.ts | 96.09% | 100% | 36 |
| dynamicPromptAssembler.ts | 100% | 100% | 15 |
| parallelExecuteEngine.ts | 98.12% | 100% | 26 |
| **discovery 模块合计** | **97.68%** | **100%** | **77** |
